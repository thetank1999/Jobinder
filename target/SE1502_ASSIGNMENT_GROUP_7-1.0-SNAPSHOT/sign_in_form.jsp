                ...
                <div class="card-body">
                    ...
                    <form action="signin" method="POST">
                        <fieldset class="form-group">
                            ...
                            <input type="email" class="form-control mb-3" id="email" name="email" value="<c:out value="${cookie.email.value}"/>" required /> 
                        </fieldset>
                        <fieldset class="form-group">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="resetpassword" class="mt-2 btn btn-link" >Quên mật khẩu</a>
                        </div>
                    </form>
                </div>
            </div>
